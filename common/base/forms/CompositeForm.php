...
{
    /** @var array Set null if all forms are enabled*/
    public $enabledForms;
    /**
     * @var Model[]|array[]
     */
     ...
     * @return array
     */
    abstract public function includedForms();
    
    /**
     * @return array of internal forms like ['meta', 'values']
     */
    protected function _includedForms()
    {
        return ($this->enabledForms !== null && is_array($this->enabledForms))
            ? $this->enabledForms
            : $this->includedForms();
    }
    ...
    public function load($data, $formName = null)
    {
        ...
        foreach ($this->_includedForms() as $name) {
     ...
     * @param string $name
     *
     * @return array|mixed|\yii\base\Model
    ...
    {
        if (in_array($name, $this->includedForms(), true)) {
