        ...
        <div class="col-md-12">
            <div class="row slider-position">
                ...
                <div class="col-md-9 col-sm-8 col-xs-12 main-content ">
                    ...
                    <p><span style="color: rgb(0, 0, 0); font-family: helvetica, tahoma, verdana, Helvetica, sans-serif; font-size: 13px;">Оплата наличными производится в пункте самовывоза. Вместе с товаром Вам передаются товарный и кассовый чеки.&nbsp;</span></p>
                    ...
                    <p><span style="color:#000000;">1. &nbsp; <strong>Доставка почтой</strong></span></p>
                    ...
                    <p><span style="color:#000000;">2.&nbsp;</span><strong style="color: rgb(0, 0, 0); font-size: 10pt;">&nbsp;Самовывоз</strong></p>
                    <p><span style="color:#000000;">Мы находимся по адресу: <?=\Yii::$app->params['contacts']['Адрес']?></span></p>
