...
use common\modules\order\widgets\Informer;
use kartik\export\ExportMenu;
use nex\datepicker\DatePicker;
use common\modules\order\assets\Asset;
use common\modules\order\assets\OrdersListAsset;
use common\modules\order\widgets\AssigmentToOrder;
...
$columns[] = [
    ...
    'value' => function($model) use ($module) {
        ...
        return \common\modules\order\widgets\ChangeStatus::widget(['model' => $model]);
    }
];
