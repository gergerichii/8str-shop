    ...
    public function safeUp()
    {
        ...
        try {
            ...
            $this->insert('{{%order_field_type}}', [
                'id' => '1',
                'name' => 'Input',
                'widget' => 'common\modules\order\widgets\field_type\Input',
                'have_variants' => 'no',
            ]);
            $this->insert('{{%order_field_type}}', [
                'id' => '2',
                'name' => 'Textarea',
                'widget' => 'common\modules\order\widgets\field_type\Textarea',
                'have_variants' => 'no',
            ]);
            $this->insert('{{%order_field_type}}', [
                'id' => '3',
                'name' => 'Select',
                'widget' => 'common\modules\order\widgets\field_type\Select',
                'have_variants' => 'yes',
            ]);
            $this->insert('{{%order_field_type}}', [
                'id' => '4',
                'name' => 'Checkbox',
                'widget' => 'common\modules\order\widgets\field_type\Checkbox',
                'have_variants' => 'yes',
            ]);
