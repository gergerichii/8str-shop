...
use common\modules\order\models\SimpleOrder;
...
//            ],
    ...
    public function actionIndex($tab = 'orders')
    {
        ...
        $this->getView()->registerJs('shop.orders_list.elementsUrl = "'.Url::toRoute(['/order/tools/ajax-elements-list']).'";');
    ...
    public function actionOrderSimpleCreateAjax()
    {
        ...
        if ($model->save()) {
            ...
            $orderEvent = new \common\modules\order\events\OrderEvent(['model' => $model, 'elements' => $model->elements]);
