...
(function ($) {
    ...
    var Venedor = {
            ...
            items.each(function () {
                ...
                if ($this.hasClass('item-hover') || $this.closest('.carousel-inner').length) {
                    ...
                    if ($this.width() < 220) {
                        ...
                        $this.find('.ratings-container.pull-right, .item-price-container.pull-left').css({
                            'float': 'none',
                            'display': 'block',
                            'width': '100%'
                        });
                        ...
                        $this.find('.item-price-container.pull-left').css({
                            'float': 'left',
                            'width': 'auto',
                            'margin-bottom': 0
                        });
        ...
        owlCarousels: function () {
            ...
            /* top tab sliders - index.html */
            $('.top-tab-slider.owl-carousel').each(function (index, item) {
                if (self.checkSupport($(item), $.fn.owlCarousel)) {
                    var tabid = $(item).parent('.tab-pane.tab-carousel-wrapper').attr('id');
                    ...
                    $(item).owlCarousel({
                        ...
                        mouseDrag: true,
                        autoHeight: true
                    }).data('navigationBtns', ['#' + tabid + '-tab-slider-prev', '#' + tabid + '-tab-slider-next']);
                }
            });
